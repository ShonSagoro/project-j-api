...
@Service
public class GoogleDriveManagerServiceImpl {
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                ...
                .build();
        LocalServerReceiver receiver = new LocalServerReceiver.Builder().setHost("https://192.168.100.6.nip.io").setPort(8080).build();
